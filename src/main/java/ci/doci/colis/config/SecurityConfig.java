package ci.doci.colis.config;

import ci.doci.colis.security.CustomAuthenticationProvider;
import ci.doci.colis.service.CustomUserDetailsService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.
                ...
                .antMatchers("/dg/**").hasAnyRole("DG","ADMIN","SUPERVISEUR")
                .antMatchers("/raf/**").hasAnyRole("DG","SUPERADMIN","RAF")
                .antMatchers("/agent/**").hasAnyRole("AGENT","SUPERVISEUR")
